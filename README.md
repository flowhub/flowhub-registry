Flowhub Runtime Registry library [![Build Status](https://secure.travis-ci.org/the-grid/flowhub-registry.png?branch=master)](http://travis-ci.org/the-grid/flowhub-registry)
================================
